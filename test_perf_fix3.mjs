...
async function checkBloat() {
   ...
   const SELECT_FIELDS = `
     id, figure_name, name, slug_tr, slug, slug_en, figure_code, code, figure_number, figure_no,
     ...
     series:series_id(id, series_name, title, slug_tr, slug, slug_en, series_no, category_main, category, manual_rarity, rarity, final_rarity)
   `;
   ...
   console.log(`[NEW PROJECTION] Fetched ${d2.length} records in ${time2}ms.`);
