...
export default async function SeriesDetail({
  ...
  // Seri verisini çek
  const { data: series, error } = await supabase.from('series').select('*').eq('id', id).single();
  ...
  return (
    <div className="bg-white min-h-screen pb-20 w-full">
      ...
      <div className="max-w-6xl mx-auto -mt-6 relative z-20 bg-[#f8f8f8] rounded-md shadow-md grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200 border border-gray-200">
        ...
        <div className="p-6 md:p-8 flex items-center justify-center gap-4">
          ...
          <div>
            ...
            <p className="font-black text-[15px] truncate max-w-[120px] text-gray-900">{series.category || '-'}</p>
          </div>
        </div>
        <div className="p-6 md:p-8 flex items-center justify-center gap-4">
           <div className="text-gray-300">
        ...
        <div className="p-6 md:p-8 flex items-center justify-center gap-4">
          ...
          <div>
            ...
            <p className="font-black text-[15px] text-gray-900">{series.release_month} {series.release_year}</p>
          </div>
        </div>
      </div>
      ...
      {(series.description || series.box_image_url) && (
        <div className="max-w-6xl mx-auto px-8 mt-32 flex flex-col md:flex-row gap-16 items-center">
      ...
      <div className="max-w-4xl mx-auto px-8 mt-24 border-t border-gray-200 pt-24 grid grid-cols-2 text-center">
      ...
      {(series.description_2 || series.collector_image_url) && (
          <div className="max-w-6xl mx-auto px-8 mt-32 flex flex-col md:flex-row-reverse gap-16 items-center">
            <div className="md:w-[40%]">
      ...
      <div className="max-w-7xl mx-auto px-8 mt-32 border-t border-gray-200 pt-24">
        ...
        {figures.length === 0 ? (
            <div className="py-24 text-center border-2 border-dashed border-gray-200 rounded-xl bg-gray-50">
