...
import { deleteSliderData } from '@/app/cto/actions/slider';
  ...
  return (
    <div className="p-12 space-y-8 pb-32">
        <div className="flex justify-between items-center bg-white p-6 rounded-md shadow-sm border border-gray-200">
            ...
            <Link href="/cto/slaytlar/yeni" className="bg-black hover:bg-[#D22B2B] text-white transition-colors px-6 py-3 rounded-sm flex items-center gap-2 text-[11px] font-black uppercase tracking-widest shadow-md">
                        ...
                        {sliders.map(s => (
                            <tr key={s.id} className="hover:bg-gray-50 transition-colors">
                                ...
                                <td className="p-4 pr-6 flex justify-end gap-2">
                                    <Link href={`/cto/slaytlar/${s.id}`} className="p-2 text-blue-600 hover:bg-blue-50 rounded-md transition-colors">
                                        <Pencil size={18} />
                                    </Link>
