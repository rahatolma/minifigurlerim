...
import { deleteNewsData } from '@/app/cto/actions/news';
    ...
    <div className="w-full max-w-[1600px] mx-auto p-12 pb-24">
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
        ...
        <div className="flex items-center gap-4 w-full md:w-auto">
          ...
          />
          <Link href="/cto/haberler/yeni" className="bg-black text-white px-8 py-4 rounded-sm shadow-md text-xs font-black tracking-widest flex items-center gap-2 hover:bg-gray-800 transition-all uppercase whitespace-nowrap">
                    ...
                    <tr key={n.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-8 py-4">
                         <div className="flex items-center justify-end gap-1">
                           <Link href={`/cto/haberler/${n.id}`} className="p-2 text-gray-300 hover:text-blue-600 hover:bg-blue-50 rounded transition-all"><Edit size={16} /></Link>
