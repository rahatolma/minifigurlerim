...
export default function MultiMarketButton({ customLink, amazonUrl, trendyolUrl, hepsiburadaUrl, trackingProps }: Props) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-3 w-full animate-in fade-in duration-300">
        <a href={amazonUrl} onClick={() => trackClickMarketplace({ ...trackingProps, marketplace: 'amazon_tr' })} target="_blank" rel="noopener noreferrer" className="flex flex-col items-center justify-center gap-1 px-4 py-3 bg-[#fcfcfc] border border-gray-200 rounded-xl hover:border-[#FF9900] hover:bg-orange-50/30 hover:shadow-sm transition-all group">
        ...
        <a href={trendyolUrl} onClick={() => trackClickMarketplace({ ...trackingProps, marketplace: 'trendyol' })} target="_blank" rel="noopener noreferrer" className="flex flex-col items-center justify-center gap-1 px-4 py-3 bg-[#fcfcfc] border border-gray-200 rounded-xl hover:border-[#F27A1A] hover:bg-orange-50/30 hover:shadow-sm transition-all group">
        ...
        <a href={hepsiburadaUrl} onClick={() => trackClickMarketplace({ ...trackingProps, marketplace: 'hepsiburada' })} target="_blank" rel="noopener noreferrer" className="flex flex-col items-center justify-center gap-1 px-4 py-3 bg-[#fcfcfc] border border-gray-200 rounded-xl hover:border-[#FF6000] hover:bg-orange-50/30 hover:shadow-sm transition-all group">
