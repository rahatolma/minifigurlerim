  ...
  return (
    <div ref={wrapperRef} className={`relative hidden md:block ${wrapperClass}`}>
      <div 
        ...
        className="w-full h-full border border-gray-200 bg-white shadow-sm rounded-lg px-4 py-3 text-[13px] font-bold outline-none cursor-pointer text-black hover:border-black transition-all flex justify-between items-center group bg-no-repeat"
        style={{
